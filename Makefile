xw5-ilc: main.o Program.o INIReader.o
	g++ --std=c++17 -o xw5-ilc ../inih/ini.o INIReader.o main.o Program.o ../wwiv-stock-build/bbs/libbbs_lib.a ../wwiv-stock-build/sdk/libsdk.a ../wwiv-stock-build/core/libcore.a ../odoors/libs-Linux/libODoors.a
